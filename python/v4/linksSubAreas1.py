...
def linksSubAreas1():
    ...
    os.makedirs('data/links/linksSubAreas', exist_ok=True)

    # Salvar os links em um arquivo JSON
    with open('data/links/linksSubAreas/linksSubAreas3.json', 'w', encoding='utf-8') as file:
        json.dump(links_subareas, file, ensure_ascii=False, indent=4)

    print("Links das subáreas foram salvos")
